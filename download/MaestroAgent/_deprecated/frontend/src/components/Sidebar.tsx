import {
  LayoutDashboard, Workflow, Network, RefreshCw, TerminalSquare,
  FolderTree, BarChart3, LayoutTemplate, Conductor,
} from "lucide-react";
    ...
    <aside className="w-56 bg-surface-1 border-r border-surface-3 flex flex-col">
      <div className="px-4 py-4 flex items-center gap-2 border-b border-surface-3">
        ...
        <div>
          ...
          <div className="text-[10px] text-ink-low font-mono">v0.1.0 · PWA</div>
        </div>
      </div>
