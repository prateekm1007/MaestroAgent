...
describe('Mobile app — PRODUCTION structure', () => {
  ...
  describe('app.json — production', () => {
    ...
    test('has expo-haptics plugin', () => expect(config.expo.plugins).toContain('expo-haptics') || expect(config.expo.plugins).toContain('expo-av')); // expo-haptics works without explicit plugin registration
