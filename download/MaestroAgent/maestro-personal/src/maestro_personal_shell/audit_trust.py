    ...
    try:
        ...
        if not is_llm_available():
            return {
                ...
                "description": "All processing is local. No data leaves your device. "
                               "Rule-based intelligence only (no AI).",
            }
        ...
        if provider == "ollama":
            return {
                ...
                "provider": provider,
                "data_location": "on-device",
                "description": "AI processing is local (Ollama). No data leaves your device.",
            }
        ...
        return {
            ...
            "provider": provider,
            "data_location": "cloud",
            "description": f"AI processing via {provider}. Signal text is sent to the "
                           f"LLM provider for intelligence generation. "
                           f"Set up Ollama for fully local processing.",
        }
    except Exception:
        return {
            "mode": "local_rules",
            "provider": "none",
            "data_location": "on-device",
            "description": "Processing mode unavailable — defaulting to local rules.",
        }
