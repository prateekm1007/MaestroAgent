...
class PostgresConnection:
    ...
    def execute(self, sql: str, params: tuple = ()) -> Any:
        ...
        # The connection was created with cursor_factory=DictCursor (line 82)
        # which returns DictRow objects supporting BOTH row["column"] and
        # row[0] — compatible with sqlite3.Row patterns AND tuple patterns.
