...
def build_markdown() -> str:
    ...
    lines.append("")
    lines.append("**Version:** 2.0 (2026-07-03) · **Commit:** `8c5b463` · **31 surfaces + ambient layer**")
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("- 31 surfaces render real content (0 thin, 0 empty)")
    lines.append("- 0 page errors, 0 console errors, 0 CSP violations")
    ...
    lines.append("- 1958+ tests; 17 passed in test_oauth_self_service (was 7 failed)")
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("- **0 page errors, 0 console errors, 0 CSP violations.** First time ever 0 console errors.")
    ...
    lines.append("- **Ambient layer.** Whisper API returns 4-part format. 9 delivery surfaces. Outcome tracking.")
    ...
    lines.append("")
    lines.append("Pilot-ready with scoped claims. The path to 9/10 is 4 external-resource items")
    lines.append("(Chrome QA, pentest, connector tests, soak test), each with a concrete trigger.")
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("")
    lines.append("**Commit:** `8c5b463` · **Date:** 2026-07-03 · **Generated by execution, not by hand.**")
