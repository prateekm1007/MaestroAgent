  ...
  el.innerHTML = `
    <div class="space-y-3">
      ...
      <div class="grid grid-cols-2 gap-4 pt-3 border-t border-white/[0.05]">
        ...
        <div><div class="text-[10px] uppercase text-fg-500">Confidence</div><div class="conf-bar mt-1"><div class="conf-bar-track"><div class="conf-bar-fill" class="b-wsconfidence100p"></div></div><span class="text-brand-cyan font-bold">${formatConfidence(s.confidence)}</span></div></div>
      </div>
...
function renderECCAsk() {
  ...
  el.innerHTML = `
    <div class="space-y-3">
      ...
      <div id="ecc-ask-answer" class="d-none" class="space-y-3">
