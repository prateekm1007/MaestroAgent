...
/**
 * SpawnSubagentModal — spawn a new sub-agent under a supervisor.
 *
 * Triggered from the AgentTree when the user clicks "Spawn sub-agent"
 * on a supervisor node. The new sub-agent is queued in the audit log
 * and the supervisor picks it up on its next iteration.
 */
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g. 10 years building auth systems..."
              rows={2}
              className="input w-full resize-none"
            />
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {availableTools.map((t) => (
                <button
                  ...
                  className={`badge ${
                    tools.includes(t) ? "badge-info" : "bg-surface-3 text-ink-low"
                  } cursor-pointer`}
                >
                  {t}
                </button>
